...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/calendar`
...
```js
await sdv.nwsl.espnNwslCalendar({});
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_calendar(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/groups`
...
```js
await sdv.nwsl.espnNwslConferences({});
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_conferences(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/draft`
...
```js
await sdv.nwsl.espnNwslDraft({});
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_draft(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/injuries`
...
```js
await sdv.nwsl.espnNwslInjuries({});
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_injuries(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/news`
...
```js
await sdv.nwsl.espnNwslNews({});
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_news(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/scoreboard`
...
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_scoreboard(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/v2/sports/soccer/usa.nwsl/standings`
...
```js
await sdv.nwsl.espnNwslStandings({});
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_standings(...)
```

## `espnNwslStatisticsLeague`

NWSL — statistics league (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/statistics`
...
```js
await sdv.nwsl.espnNwslStatisticsLeague({});
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_statistics_league(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/summary`
...
```js
await sdv.nwsl.espnNwslSummary({});
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_summary(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/teams/{team_id}`
...
```js
await sdv.nwsl.espnNwslTeam({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_team(...)
```

## `espnNwslTeamDepthcharts`

NWSL — team depthcharts (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/teams/{team_id}/depthcharts`
...
```js
await sdv.nwsl.espnNwslTeamDepthcharts({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_team_depthcharts(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/teams/{team_id}/history`
...
```js
await sdv.nwsl.espnNwslTeamHistory({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_team_history(...)
```

## `espnNwslTeamInjuries`

NWSL — team injuries (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/teams/{team_id}/injuries`
...
```js
await sdv.nwsl.espnNwslTeamInjuries({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_team_injuries(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/teams/{team_id}/leaders`
...
```js
await sdv.nwsl.espnNwslTeamLeaders({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_team_leaders(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/teams/{team_id}/news`
...
```js
await sdv.nwsl.espnNwslTeamNews({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_team_news(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/teams/{team_id}/record`
...
```js
await sdv.nwsl.espnNwslTeamRecord({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_team_record(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/teams/{team_id}/roster`
...
```js
await sdv.nwsl.espnNwslTeamRoster({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_team_roster(...)
```

## `espnNwslTeamSchedule`

NWSL — team schedule (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/teams/{team_id}/schedule`
...
```js
await sdv.nwsl.espnNwslTeamSchedule({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_team_schedule(...)
```

## `espnNwslTeamTransactions`

NWSL — team transactions (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/teams/{team_id}/transactions`
...
```js
await sdv.nwsl.espnNwslTeamTransactions({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_team_transactions(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/teams`
...
```js
await sdv.nwsl.espnNwslTeamsSite({});
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_teams_site(...)
```

## `espnNwslTransactions`

NWSL — transactions (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.nwsl/transactions`
...
```js
await sdv.nwsl.espnNwslTransactions({});
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_transactions(...)
```
