...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/soccer/usa.nwsl/statistics/byathlete`
...
```js
await sdv.nwsl.espnNwslLeaders({});
// snake_case alias (py/R parity): sdv.nwsl.espn_nwsl_leaders(...)
```
