...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/soccer/esp.1/statistics/byathlete`
...
```js
await sdv.laliga.espnLaligaLeaders({});
// snake_case alias (py/R parity): sdv.laliga.espn_laliga_leaders(...)
```
