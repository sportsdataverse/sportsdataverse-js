...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/hockey/mens-college-hockey/statistics/byathlete`
...
```js
await sdv.mch.espnMchLeaders({});
// snake_case alias (py/R parity): sdv.mch.espn_mch_leaders(...)
```
