...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/football/ufl/statistics/byathlete`
...
```js
await sdv.ufl.espnUflLeaders({});
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_leaders(...)
```
