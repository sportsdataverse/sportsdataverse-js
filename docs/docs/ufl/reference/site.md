...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/calendar`
...
```js
await sdv.ufl.espnUflCalendar({});
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_calendar(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/groups`
...
```js
await sdv.ufl.espnUflConferences({});
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_conferences(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/draft`
...
```js
await sdv.ufl.espnUflDraft({});
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_draft(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/injuries`
...
```js
await sdv.ufl.espnUflInjuries({});
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_injuries(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/news`
...
```js
await sdv.ufl.espnUflNews({});
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_news(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/scoreboard`
...
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_scoreboard(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/v2/sports/football/ufl/standings`
...
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_standings(...)
```

## `espnUflStatisticsLeague`

UFL — statistics league (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/statistics`
...
```js
await sdv.ufl.espnUflStatisticsLeague({});
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_statistics_league(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/summary`
...
```js
await sdv.ufl.espnUflSummary({});
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_summary(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/teams/{team_id}`
...
```js
await sdv.ufl.espnUflTeam({ team_id: '…' });
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_team(...)
```

## `espnUflTeamDepthcharts`

UFL — team depthcharts (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/teams/{team_id}/depthcharts`
...
```js
await sdv.ufl.espnUflTeamDepthcharts({ team_id: '…' });
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_team_depthcharts(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/teams/{team_id}/history`
...
```js
await sdv.ufl.espnUflTeamHistory({ team_id: '…' });
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_team_history(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/teams/{team_id}/injuries`
...
```js
await sdv.ufl.espnUflTeamInjuries({ team_id: '…' });
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_team_injuries(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/teams/{team_id}/leaders`
...
```js
await sdv.ufl.espnUflTeamLeaders({ team_id: '…' });
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_team_leaders(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/teams/{team_id}/news`
...
```js
await sdv.ufl.espnUflTeamNews({ team_id: '…' });
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_team_news(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/teams/{team_id}/record`
...
```js
await sdv.ufl.espnUflTeamRecord({ team_id: '…' });
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_team_record(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/teams/{team_id}/roster`
...
```js
await sdv.ufl.espnUflTeamRoster({ team_id: '…' });
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_team_roster(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/teams/{team_id}/schedule`
...
```js
await sdv.ufl.espnUflTeamSchedule({ team_id: '…' });
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_team_schedule(...)
```

## `espnUflTeamTransactions`

UFL — team transactions (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/teams/{team_id}/transactions`
...
```js
await sdv.ufl.espnUflTeamTransactions({ team_id: '…' });
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_team_transactions(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/teams`
...
```js
await sdv.ufl.espnUflTeamsSite({});
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_teams_site(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/ufl/transactions`
...
```js
await sdv.ufl.espnUflTransactions({});
// snake_case alias (py/R parity): sdv.ufl.espn_ufl_transactions(...)
```
