...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/soccer/usa.1/statistics/byathlete`
...
```js
await sdv.mls.espnMlsLeaders({});
// snake_case alias (py/R parity): sdv.mls.espn_mls_leaders(...)
```
