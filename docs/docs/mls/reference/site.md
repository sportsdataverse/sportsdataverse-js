...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/calendar`
...
```js
await sdv.mls.espnMlsCalendar({});
// snake_case alias (py/R parity): sdv.mls.espn_mls_calendar(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/groups`
...
```js
await sdv.mls.espnMlsConferences({});
// snake_case alias (py/R parity): sdv.mls.espn_mls_conferences(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/draft`
...
```js
await sdv.mls.espnMlsDraft({});
// snake_case alias (py/R parity): sdv.mls.espn_mls_draft(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/injuries`
...
```js
await sdv.mls.espnMlsInjuries({});
// snake_case alias (py/R parity): sdv.mls.espn_mls_injuries(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/news`
...
```js
await sdv.mls.espnMlsNews({});
// snake_case alias (py/R parity): sdv.mls.espn_mls_news(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/scoreboard`
...
// snake_case alias (py/R parity): sdv.mls.espn_mls_scoreboard(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/v2/sports/soccer/usa.1/standings`
...
```js
await sdv.mls.espnMlsStandings({});
// snake_case alias (py/R parity): sdv.mls.espn_mls_standings(...)
```

## `espnMlsStatisticsLeague`

MLS — statistics league (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/statistics`
...
```js
await sdv.mls.espnMlsStatisticsLeague({});
// snake_case alias (py/R parity): sdv.mls.espn_mls_statistics_league(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/summary`
...
```js
await sdv.mls.espnMlsSummary({});
// snake_case alias (py/R parity): sdv.mls.espn_mls_summary(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/teams/{team_id}`
...
```js
await sdv.mls.espnMlsTeam({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mls.espn_mls_team(...)
```

## `espnMlsTeamDepthcharts`

MLS — team depthcharts (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/teams/{team_id}/depthcharts`
...
```js
await sdv.mls.espnMlsTeamDepthcharts({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mls.espn_mls_team_depthcharts(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/teams/{team_id}/history`
...
```js
await sdv.mls.espnMlsTeamHistory({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mls.espn_mls_team_history(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/teams/{team_id}/injuries`
...
```js
await sdv.mls.espnMlsTeamInjuries({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mls.espn_mls_team_injuries(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/teams/{team_id}/leaders`
...
```js
await sdv.mls.espnMlsTeamLeaders({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mls.espn_mls_team_leaders(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/teams/{team_id}/news`
...
```js
await sdv.mls.espnMlsTeamNews({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mls.espn_mls_team_news(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/teams/{team_id}/record`
...
```js
await sdv.mls.espnMlsTeamRecord({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mls.espn_mls_team_record(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/teams/{team_id}/roster`
...
```js
await sdv.mls.espnMlsTeamRoster({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mls.espn_mls_team_roster(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/teams/{team_id}/schedule`
...
```js
await sdv.mls.espnMlsTeamSchedule({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mls.espn_mls_team_schedule(...)
```

## `espnMlsTeamTransactions`

MLS — team transactions (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/teams/{team_id}/transactions`
...
```js
await sdv.mls.espnMlsTeamTransactions({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mls.espn_mls_team_transactions(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/teams`
...
```js
await sdv.mls.espnMlsTeamsSite({});
// snake_case alias (py/R parity): sdv.mls.espn_mls_teams_site(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/transactions`
...
```js
await sdv.mls.espnMlsTransactions({});
// snake_case alias (py/R parity): sdv.mls.espn_mls_transactions(...)
```
