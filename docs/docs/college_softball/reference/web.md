...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/baseball/college-softball/statistics/byathlete`
...
```js
await sdv.college_softball.espnCollegeSoftballLeaders({});
// snake_case alias (py/R parity): sdv.college_softball.espn_college_softball_leaders(...)
```
