...
```js
await sdv.nhl.espnNhlCalendar({});
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_calendar(...)
```
...
```js
await sdv.nhl.espnNhlConferences({});
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_conferences(...)
```
...
```js
await sdv.nhl.espnNhlDraft({});
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_draft(...)
```
...
```js
await sdv.nhl.espnNhlInjuries({});
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_injuries(...)
```
...
```js
await sdv.nhl.espnNhlNews({});
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_news(...)
```
...
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_scoreboard(...)
```
...
```js
await sdv.nhl.espnNhlStandings({});
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_standings(...)
```

## `espnNhlStatisticsLeague`
...
```js
await sdv.nhl.espnNhlStatisticsLeague({});
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_statistics_league(...)
```
...
```js
await sdv.nhl.espnNhlSummary({});
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_summary(...)
```
...
```js
await sdv.nhl.espnNhlTeam({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_team(...)
```

## `espnNhlTeamDepthcharts`
...
```js
await sdv.nhl.espnNhlTeamDepthcharts({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_team_depthcharts(...)
```
...
```js
await sdv.nhl.espnNhlTeamHistory({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_team_history(...)
```
...
```js
await sdv.nhl.espnNhlTeamInjuries({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_team_injuries(...)
```
...
```js
await sdv.nhl.espnNhlTeamLeaders({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_team_leaders(...)
```
...
```js
await sdv.nhl.espnNhlTeamNews({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_team_news(...)
```
...
```js
await sdv.nhl.espnNhlTeamRecord({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_team_record(...)
```
...
```js
await sdv.nhl.espnNhlTeamRoster({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_team_roster(...)
```
...
```js
await sdv.nhl.espnNhlTeamSchedule({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_team_schedule(...)
```

## `espnNhlTeamTransactions`
...
```js
await sdv.nhl.espnNhlTeamTransactions({ team_id: '…' });
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_team_transactions(...)
```
...
```js
await sdv.nhl.espnNhlTeamsSite({});
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_teams_site(...)
```
...
```js
await sdv.nhl.espnNhlTransactions({});
// snake_case alias (py/R parity): sdv.nhl.espn_nhl_transactions(...)
```
