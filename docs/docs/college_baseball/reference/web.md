...
```js
await sdv.college_baseball.espnCollegeBaseballLeaders({});
// snake_case alias (py/R parity): sdv.college_baseball.espn_college_baseball_leaders(...)
```
