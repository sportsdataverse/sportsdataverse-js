...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/cricket/{league}/statistics/byathlete`
...
```js
await sdv.cricket.espnCricketLeaders({ league: 'eng.1' });
// snake_case alias (py/R parity): sdv.cricket.espn_cricket_leaders(...)
```
