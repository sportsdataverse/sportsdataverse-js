...
```js
await sdv.mlb.espnMlbCalendar({});
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_calendar(...)
```
...
```js
await sdv.mlb.espnMlbConferences({});
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_conferences(...)
```
...
```js
await sdv.mlb.espnMlbDraft({});
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_draft(...)
```
...
```js
await sdv.mlb.espnMlbInjuries({});
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_injuries(...)
```
...
```js
await sdv.mlb.espnMlbNews({});
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_news(...)
```
...
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_scoreboard(...)
```
...
```js
await sdv.mlb.espnMlbStandings({});
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_standings(...)
```

## `espnMlbStatisticsLeague`
...
```js
await sdv.mlb.espnMlbStatisticsLeague({});
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_statistics_league(...)
```
...
```js
await sdv.mlb.espnMlbSummary({});
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_summary(...)
```
...
```js
await sdv.mlb.espnMlbTeam({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_team(...)
```

## `espnMlbTeamDepthcharts`
...
```js
await sdv.mlb.espnMlbTeamDepthcharts({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_team_depthcharts(...)
```
...
```js
await sdv.mlb.espnMlbTeamHistory({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_team_history(...)
```
...
```js
await sdv.mlb.espnMlbTeamInjuries({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_team_injuries(...)
```
...
```js
await sdv.mlb.espnMlbTeamLeaders({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_team_leaders(...)
```
...
```js
await sdv.mlb.espnMlbTeamNews({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_team_news(...)
```
...
```js
await sdv.mlb.espnMlbTeamRecord({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_team_record(...)
```
...
```js
await sdv.mlb.espnMlbTeamRoster({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_team_roster(...)
```
...
```js
await sdv.mlb.espnMlbTeamSchedule({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_team_schedule(...)
```

## `espnMlbTeamTransactions`
...
```js
await sdv.mlb.espnMlbTeamTransactions({ team_id: '…' });
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_team_transactions(...)
```
...
```js
await sdv.mlb.espnMlbTeamsSite({});
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_teams_site(...)
```
...
```js
await sdv.mlb.espnMlbTransactions({});
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_transactions(...)
```
