...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/statistics/byathlete`
...
```js
await sdv.mlb.espnMlbLeaders({});
// snake_case alias (py/R parity): sdv.mlb.espn_mlb_leaders(...)
```
