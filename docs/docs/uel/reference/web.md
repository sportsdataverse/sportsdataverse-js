...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/soccer/uefa.europa/statistics/byathlete`
...
```js
await sdv.uel.espnUelLeaders({});
// snake_case alias (py/R parity): sdv.uel.espn_uel_leaders(...)
```
