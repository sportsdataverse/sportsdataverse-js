...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/soccer/ita.1/statistics/byathlete`
...
```js
await sdv.seriea.espnSerieaLeaders({});
// snake_case alias (py/R parity): sdv.seriea.espn_seriea_leaders(...)
```
