...
```js
await sdv.wbb.espnWbbCalendar({});
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_calendar(...)
```
...
```js
await sdv.wbb.espnWbbConferences({});
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_conferences(...)
```
...
```js
await sdv.wbb.espnWbbDraft({});
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_draft(...)
```
...
```js
await sdv.wbb.espnWbbInjuries({});
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_injuries(...)
```
...
```js
await sdv.wbb.espnWbbNews({});
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_news(...)
```
...
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_scoreboard(...)
```
...
```js
await sdv.wbb.espnWbbStandings({});
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_standings(...)
```

## `espnWbbStatisticsLeague`
...
```js
await sdv.wbb.espnWbbStatisticsLeague({});
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_statistics_league(...)
```
...
```js
await sdv.wbb.espnWbbSummary({});
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_summary(...)
```
...
```js
await sdv.wbb.espnWbbTeam({ team_id: '…' });
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_team(...)
```

## `espnWbbTeamDepthcharts`
...
```js
await sdv.wbb.espnWbbTeamDepthcharts({ team_id: '…' });
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_team_depthcharts(...)
```
...
```js
await sdv.wbb.espnWbbTeamHistory({ team_id: '…' });
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_team_history(...)
```
...
```js
await sdv.wbb.espnWbbTeamInjuries({ team_id: '…' });
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_team_injuries(...)
```
...
```js
await sdv.wbb.espnWbbTeamLeaders({ team_id: '…' });
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_team_leaders(...)
```
...
```js
await sdv.wbb.espnWbbTeamNews({ team_id: '…' });
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_team_news(...)
```
...
```js
await sdv.wbb.espnWbbTeamRecord({ team_id: '…' });
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_team_record(...)
```
...
```js
await sdv.wbb.espnWbbTeamRoster({ team_id: '…' });
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_team_roster(...)
```
...
```js
await sdv.wbb.espnWbbTeamSchedule({ team_id: '…' });
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_team_schedule(...)
```

## `espnWbbTeamTransactions`
...
```js
await sdv.wbb.espnWbbTeamTransactions({ team_id: '…' });
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_team_transactions(...)
```
...
```js
await sdv.wbb.espnWbbTeamsSite({});
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_teams_site(...)
```
...
```js
await sdv.wbb.espnWbbTransactions({});
// snake_case alias (py/R parity): sdv.wbb.espn_wbb_transactions(...)
```
