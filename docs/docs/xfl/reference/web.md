...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/football/xfl/statistics/byathlete`
...
```js
await sdv.xfl.espnXflLeaders({});
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_leaders(...)
```
