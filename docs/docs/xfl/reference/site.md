...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/calendar`
...
```js
await sdv.xfl.espnXflCalendar({});
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_calendar(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/groups`
...
```js
await sdv.xfl.espnXflConferences({});
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_conferences(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/draft`
...
```js
await sdv.xfl.espnXflDraft({});
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_draft(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/injuries`
...
```js
await sdv.xfl.espnXflInjuries({});
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_injuries(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/news`
...
```js
await sdv.xfl.espnXflNews({});
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_news(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/scoreboard`
...
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_scoreboard(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/v2/sports/football/xfl/standings`
...
```js
await sdv.xfl.espnXflStandings({});
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_standings(...)
```

## `espnXflStatisticsLeague`

XFL — statistics league (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/statistics`
...
```js
await sdv.xfl.espnXflStatisticsLeague({});
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_statistics_league(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/summary`
...
```js
await sdv.xfl.espnXflSummary({});
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_summary(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}`
...
```js
await sdv.xfl.espnXflTeam({ team_id: '…' });
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_team(...)
```

## `espnXflTeamDepthcharts`

XFL — team depthcharts (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/depthcharts`
...
```js
await sdv.xfl.espnXflTeamDepthcharts({ team_id: '…' });
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_team_depthcharts(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/history`
...
```js
await sdv.xfl.espnXflTeamHistory({ team_id: '…' });
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_team_history(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/injuries`
...
```js
await sdv.xfl.espnXflTeamInjuries({ team_id: '…' });
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_team_injuries(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/leaders`
...
```js
await sdv.xfl.espnXflTeamLeaders({ team_id: '…' });
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_team_leaders(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/news`
...
```js
await sdv.xfl.espnXflTeamNews({ team_id: '…' });
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_team_news(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/record`
...
```js
await sdv.xfl.espnXflTeamRecord({ team_id: '…' });
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_team_record(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/roster`
...
```js
await sdv.xfl.espnXflTeamRoster({ team_id: '…' });
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_team_roster(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/schedule`
...
```js
await sdv.xfl.espnXflTeamSchedule({ team_id: '…' });
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_team_schedule(...)
```

## `espnXflTeamTransactions`

XFL — team transactions (ESPN site.api.espn.com).

**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams/{team_id}/transactions`
...
```js
await sdv.xfl.espnXflTeamTransactions({ team_id: '…' });
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_team_transactions(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/teams`
...
```js
await sdv.xfl.espnXflTeamsSite({});
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_teams_site(...)
```
...
**Endpoint URL:** `GET https://site.api.espn.com/apis/site/v2/sports/football/xfl/transactions`
...
```js
await sdv.xfl.espnXflTransactions({});
// snake_case alias (py/R parity): sdv.xfl.espn_xfl_transactions(...)
```
