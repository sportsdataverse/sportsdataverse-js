...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/soccer/uefa.champions/statistics/byathlete`
...
```js
await sdv.ucl.espnUclLeaders({});
// snake_case alias (py/R parity): sdv.ucl.espn_ucl_leaders(...)
```
