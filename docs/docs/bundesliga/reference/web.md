...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/soccer/ger.1/statistics/byathlete`
...
```js
await sdv.bundesliga.espnBundesligaLeaders({});
// snake_case alias (py/R parity): sdv.bundesliga.espn_bundesliga_leaders(...)
```
