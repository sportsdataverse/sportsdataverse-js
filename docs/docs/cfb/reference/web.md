...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/football/college-football/statistics/byathlete`
...
```js
await sdv.cfb.espnCfbLeaders({});
// snake_case alias (py/R parity): sdv.cfb.espn_cfb_leaders(...)
```
