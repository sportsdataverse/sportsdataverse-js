...
**Endpoint URL:** `GET https://site.web.api.espn.com/apis/common/v3/sports/football/cfl/statistics/byathlete`
...
```js
await sdv.cfl.espnCflLeaders({});
// snake_case alias (py/R parity): sdv.cfl.espn_cfl_leaders(...)
```
