...
describe('NBA Games', () => {
    ...
    it('should populate play by play data for the given game id', async () => {
        const data = await app.nba.getPlayByPlay(gameId)
        should(data).exist;
        should(data).be.json;
    ...
    it('should populate box score data for the given game id', async () => {
        const data = await app.nba.getBoxScore(gameId)
        should(data).exist;
        should(data).be.json;
    ...
    it('should return a promise for game summary data for the given game id', async () => {
        const data = await app.nba.getSummary(gameId)
        should(data).exist;
        should(data).be.json;
        should(data).not.be.empty;
    ...
    it('should return a promise for game picks data for the given game id', async () => {
        const data = await app.nba.getPicks(gameId)
        should(data).exist;
        should(data).be.json;
        should(data).not.be.empty;
...
describe('NBA Teams', () => {
    ...
    it('should return a promise for teams for the given team id', async () => {
        const data = await app.nba.getTeamInfo(16)
        should(data).exist;
        should(data).be.json;
        should(data).not.be.empty;
    ...
    it('should return a promise for team players for the given team id', async () => {
        const data = await app.nba.getTeamPlayers(16)
        should(data).exist;
        should(data).be.json;
        should(data).not.be.empty;
