...
describe('parsers/mlb: parse_mlb_teams', () => {
...
describe('parsers/mlb: parse_mlb_schedule', () => {
...
describe('parsers/mlb: parse_mlb_list (generic flattener)', () => {
  it('finds the first list-valued top-level key and flattens it', () => {
    const rows = parse_mlb_list({
...
describe('parsers/mlb: parse_mlb_team_roster', () => {
...
describe('parsers/mlb: parse_mlb_standings', () => {
...
describe('parsers/mlb: parse_mlb_person_stats', () => {
...
describe('parsers/mlb: parse_mlb_boxscore', () => {
...
describe('parsers/mlb: parse_mlb_linescore', () => {
  it('produces one row per inning with flattened home/away splits', () => {
    ...
    const rows = parse_mlb_linescore(raw);
    rows.length.should.equal(2);
...
describe('parsers/mlb: parse_mlb_play_by_play', () => {
  it('produces one row per play from allPlays[] with deep-flattened keys', () => {
    ...
    const rows = parse_mlb_play_by_play(raw);
    rows.length.should.equal(2);
...
describe('parsers/mlb: parse_mlb_win_probability', () => {
  it('flattens a bare top-level array of play win-prob objects', () => {
    ...
    const rows = parse_mlb_win_probability(raw);
    rows.length.should.equal(2);
...
describe('parsers/mlb: parse_mlb_draft_latest', () => {
  it('flattens the single {pick, ...} object as one row, dropping copyright', () => {
    ...
    const rows = parse_mlb_draft_latest(raw);
...
describe('parsers/mlb: parse_mlb_timecodes', () => {
  it('shapes a bare array of timecode strings into a single timecode column', () => {
    const rows = parse_mlb_timecodes(['20230929_215457', '20230929_215512']);
    rows.length.should.equal(2);
