...
describe('parsers/yahoo_scores: parse_yahoo_scores_list (generic)', () => {
...
describe('parsers/yahoo_scores: parse_yahoo_scores_scoreboard', () => {
  it('unrolls service.scoreboard.games keyed map into one row per game (key -> id)', () => {
    ...
    const rows = parse_yahoo_scores_scoreboard(raw);
    rows.length.should.equal(2);
...
describe('parsers/yahoo_scores: parse_yahoo_scores_boxscore', () => {
  it('unrolls service.boxscore.player_stats keyed map into one row per player', () => {
    ...
    const rows = parse_yahoo_scores_boxscore(raw);
    rows.length.should.equal(2);
