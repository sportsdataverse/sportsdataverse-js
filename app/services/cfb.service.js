...
const cfb = module.exports = {
    cfb: {
         ...
         */
        getSchedule: async ({year = null, month = null, day = null, groups = 80, seasontype = 2}) => {
         ...
         * )
         */
        getScoreboard: async ({year = null, month = null, day = null, groups = 80, seasontype = 2, limit = 300}) => {
         ...
         */
        getStandings: async ({year = new Date().getFullYear(), group = 80}) => {
