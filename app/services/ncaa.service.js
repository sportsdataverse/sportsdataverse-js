...
const ncaa = module.exports = {
    ncaa: {
         ...
         * const gameId = await sdv.ncaa.getNcaaRedirectUrl(url=urlGame);
         */
        getNcaaRedirectUrl: async (url) => {
         ...
         * @returns json
         * @example
         * const result = await sdv.ncaa.getNcaaTeamStats(5764053);
         */
        getNcaaTeamStats: async (game) => {
         ...
         * @returns json
         * @example
         * const result = await sdv.ncaa.getNcaaScoringSummary(5764053);
         */
        getNcaaScoringSummary: async (game) => {
         ...
         * )
         */
        getNcaaScoreboard: async (sport,division,year,month ,day) => {
         ...
         */
        getDivisions: async (sport, season) => {
            if (!sport || !season) {
                return;
            }
         ...
         */
        getSportDivisionData: async(sport, season, division, type, gameHigh) => {
         ...
         */
        getPlayerData: async (sport, season, division, rankingPeriod, gameHigh, category) => {
            const baseUrl = 'http://stats.ncaa.org/rankings/change_sport_year_div';
            const params = {
                "sport_code": sport,
                "academic_year": season || '',
         ...
         */
        getTeamData: async (sport, season, division, rankingPeriod, gameHigh, category) => {
            const baseUrl = 'http://stats.ncaa.org/rankings/change_sport_year_div';
            const params = {
                "sport_code": sport,
                "academic_year": season || '',
